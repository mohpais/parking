...
const makeBill = (car) => {
    ...
    var bill = hoursBilled < 2 ? (payFirstHour * hoursBilled) : (payFirstHour + (hoursBilled) * payPerHour)
    let billValue = car.isParked ? "-" : "Rp " + bill;
    return billValue;
}
...
const addCar = () => {
    ...
    // Add new car to the cars array and validation no licence
